          ...
          <div className="rtl-container">
            <div className="arabic-text text-lg text-foreground/90 space-y-6">
              <p>
                ...
                الشمالي. تتميز القرية بموقع ريفي جميل على منحدرات خفيفة وليس على
                جبل عالي، وتجمع بين جمال الطبيعة وعراقة التاريخ.
              </p>

              <p>
                يمر بها نهر أبو علي (المعروف أيضاً باسم نهر القديša — Kadisha)
                الذي ينبع من قرب قلعة قرنة السوداء ويتعرّف بوادي القديša ويتجه
                نحو طرابلس، ويُعد من المكونات الطبيعية الهامة في المنطقة.
              </p>
